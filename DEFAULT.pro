...
// task change.
//
// written by david.c.godlove@vanderbilt.edu 	July, 2011, edited by Zachary J.J. Roper z.roper@vanderbilt.edu	April 10, 2017
...
if(monkey == helmholtz)
		...
		Allowed_fix_time		= 5000;
		Max_saccade_time		= 2000;
		Base_Reward_time		= 100;
		Base_Punish_time		= 1000;
